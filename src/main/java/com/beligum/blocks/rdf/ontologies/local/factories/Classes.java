...
import com.beligum.blocks.rdf.ifaces.RdfName;
...
public class Classes implements RdfResourceFactory
{
    ...
    enum Members implements RdfName
    {
        Page;

        @Override
        public RdfResource get() {
            return null;
        }
        @Override
        public void set() {
     ...
     */
    public static final RdfClass Page = new RdfClassImpl(Members.Page,
                                                         Local.INSTANCE,
