...
}(this, function ()
{
    ...
    (function ()
    {
        ...
        Events.prototype = {
            ...
            updateFocus: function (target, eventObj)
            {
                ...
                var externalEvent = !Util.isDescendant(hadFocus, target, true) && !Util.isDescendant(toolbarEl, target, true) && !Util.isDescendant(previewEl, target, true);
        ...
        PasteHandler = Extension.extend({
            ...
            handlePaste: function (event, element)
            {
                ...
                if (event.clipboardData &&
                    event.clipboardData.getData && !event.defaultPrevented) {
                    event.preventDefault();
    ...
    (function ()
    {
        ...
        MediumEditor.FormExtension = FormExtension;
