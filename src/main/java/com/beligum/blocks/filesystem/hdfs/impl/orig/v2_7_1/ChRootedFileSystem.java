...
//
///**
// * This is the original ChRootedFileSystem with some mods:
// * - made the class public
// * - made the class variables protected (instead of private) and non-final
// * - commented-out the constructor and created a matching construct() method instead
// *
// * Created by bram on 1/10/16.
// * ------------------------------------------------------------------------------
...
//{
//    protected URI myUri; // the base URI + the chRoot
//    protected Path chRootPathPart; // the root below the root of the base
//    protected String chRootPathPartString;
...
//    //    }
//
//    protected void construct(FileSystem fs) throws IOException
//    {
//        //##### This is the constructor code of org.apache.hadoop.fs.FilterFileSystem
//        //super(FileSystem.get(uri, conf));
//        this.fs = fs;
//        this.statistics = null; //will get initialized later on in initialize()
//        //#####
//
//        //##### This is the contructor code of the superclass
//        String pathString = fs.getUri().getPath();
//        if (pathString.isEmpty()) {
//            pathString = "/";
//        }
//        chRootPathPart = new Path(pathString);
