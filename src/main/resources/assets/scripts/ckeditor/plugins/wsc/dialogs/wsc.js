...
(function ()
{
    ...
    var e = function ()
    {
        ...
        return {
            postMessage: {
                ...
                {
                    var b = Object.prototype.toString, f =
                        a.fn || null, g = a.id || "", e = a.target || window, i = a.message || {id: g};
                    a.message && "[object Object]" == b.call(a.message) && (a.message.id || (a.message.id = g), i = a.message);
    ...
    {
        var c, d;
        for (d in b)c = b[d].instance.getElement().getFirst() || b[d].instance.getElement(), c.setText(a.LocalizationComing[d])
    }, B = function (b)
    {
        for (var c in b) {
    ...
    a.sendData = function (b)
    {
        ...
        {
            e = e || window.event;
            e.data.getTarget().is("a") && c != b._.currentTabId && (c = b._.currentTabId, d = b._.contents[c].Content, f = a.iframeNumber + "_" + c, a.div_overlay.setEnable(), d.getElement().getChildCount() ? v(a.targetFromFrame[f], a.cmd[c]) : (a.setIframe(d, c), g = document.getElementById(f), a.targetFromFrame[f] = g.contentWindow))
        };
    ...
    a.buildSelectLang =
        function (a)
        {
            ...
            c.setStyles({height: "auto", position: "absolute", right: "0", top: "-1px", width: "160px", "white-space": "normal"});
            d.setAttribute("id", a);
    ...
    {
        var b = a.selectNodeResponce[b], c = q(a.selectNode.synonyms);
    ...
    var s = function (a)
    {
        ...
        i.style.cssText = "position: absolute;top:30px;bottom:41px;left:1px;right:1px;z-index: 10020;padding:0;margin:0;background:" + a + ";opacity: " + g + ";filter: alpha(opacity=" +
            100 * g + ");display: none;";
        i.id = f;
        e || d.appendChild(i);
        return {
    ...
    }, C = function (b, c, d)
    {
        ...
        e.setAttributes({
            type: "radio", value: c, name: "wscGrammerSuggest",
            id: i
        });
    ...
    {
        var c = new z(b), b = "wscLang" + a.dialog.getParentEditor().name, b = document.getElementById(b),
    ...
    }, D = function (b)
    {
        if ("no_any_suggestions" == b) {
            ...
            c("ChangeTo");
            c("ChangeAll")
        } else a.LocalizationButton.ChangeTo.instance.enable(), a.LocalizationButton.ChangeAll.instance.enable(), a.LocalizationButton.ChangeTo.instance.getElement().setStyle("color", "#333"), a.LocalizationButton.ChangeAll.instance.getElement().setStyle("color",
            "#333");
        return b
    }, F = {
        ...
        grammerSuggest: function (b)
        {
            ...
            for (var b = b.grammSuggest, c = b.length, d = !0, f = 0; f < c; f++)a.grammerSuggest.getElement().append(C(b[f], b[f], d)), d = !1;
            l();
            a.div_overlay.setDisable()
        }, thesaurusSuggest: function (b)
        {
            ...
            var c = q(a.selectNode.categories), d = 0;
    ...
    CKEDITOR.dialog.add("checkspell", function (b)
    {
        ...
        return {
            title: b.config.wsc_dialogTitle || b.lang.wsc.title, minWidth: 560, minHeight: 444, buttons: [CKEDITOR.dialog.cancelButton],
            onLoad: function ()
            {
                a.dialog = this;
                u();
            ...
            }, onShow: function ()
            {
                ...
                if (CKEDITOR && CKEDITOR.config) {
                    ...
                    var c =
                        "file:" == document.location.protocol ? "http:" : document.location.protocol;
                    CKEDITOR.scriptLoader.load(b.config.wsc_customLoaderScript || c + "//loader.webspellchecker.net/sproxy_fck/sproxy.php?plugin=fck2&customerid=" + a.wsc_customerId + "&cmd=script&doc=wsc&schema=22", function (c)
                    {
                        ...
                        a.div_overlay = new s({opacity: "1", background: "#fff url(" + a.loadIcon + ") no-repeat 50% 50%", target: a.OverlayPlace});
                        ...
                        a.div_overlay_no_check = new s({
                            opacity: "1", id: "no_check_over", background: "#fff url(" + a.loadIconEmptyEditor +
                            ") no-repeat 50% 50%", target: a.OverlayPlace
                        });
            ...
            }, onHide: function ()
            {
                ...
                id: "SpellTab", label: "SpellChecker", accessKey: "S", elements: [{type: "html", id: "banner", label: "banner", style: "", html: "<div></div>"}, {
                    type: "html", id: "Content", label: "spellContent", html: "",
                    setup: function (b)
                    {
                    ...
                    type: "hbox", id: "bottomGroup", style: "width:560px; margin: 0 auto;", widths: ["50%", "50%"], children: [{
                        ...
                        type: "hbox", id: "rightCol", align: "right", width: "50%", children: [{
                            type: "vbox", id: "rightCol_col__left", widths: ["50%", "50%", "50%",
                                "50%"], children: [{
                                ...
                                type: "button",
                                id: "AddWord", label: a.LocalizationButton.AddWord.text, title: "Add word", style: "width: 100%;", onLoad: function ()
                                {
                                    this.getElement().setAttribute("title-cmd", this.id);
                    ...
                    type: "hbox",
                    id: "BlockFinishChecking", style: "width:560px; margin: 0 auto;", widths: ["70%", "30%"], onShow: function ()
                    {
                            ...
                            type: "vbox", id: "rightCol_col__left", children: [{
                                ...
                                }, onClick: function ()
                                {
                                    ...
                                    "file:" == document.location.protocol ? alert("WSC: Options functionality is disabled when runing from file system") :
                                        (p = document.activeElement, b.openDialog("options"))
                                }
                            }, {
                                type: "button", id: "FinishChecking", label: a.LocalizationButton.FinishChecking.text, title: "Finish Checking", style: "width: 100%;", onLoad: function ()
                                {
                                    this.getElement().setAttribute("title-cmd", this.id)
                                }, onClick: c
                            }]
                ...
                id: "GrammTab", label: "Grammar", accessKey: "G", elements: [{type: "html", id: "banner", label: "banner", style: "", html: "<div></div>"}, {
    ...
    CKEDITOR.dialog.add("options", function ()
    {
        ...
        return {
                ...
                id: "OptionsTab", label: "Options", accessKey: "O", elements: [{
                    ...
                    type: "vbox", id: "Options_content", children: [{
                            ...
                            type: "vbox", id: "Options_DictionaryName", children: [{
                                ...
                                onShow: function ()
                                {
                                    ...
                                    this.setValue(!e.cookie.get("udn") ?
                                        this.getValue() : e.cookie.get("udn"));
                        ...
                        type: "hbox", id: "Options_text", children: [{
                            type: "html", style: "text-align: justify;margin-top: 15px;white-space: normal!important; font-size: 12px;color:#777;", html: "<div>" +
                            a.LocalizationComing.OptionsTextIntro + "</div>", onShow: function ()
                            {
            ...
            }, onShow: function ()
            {
                ...
                d.IgnoreAllCapsWords = !c.IgnoreAllCapsWords.getValue() ?
                    0 : 1;
