        ...
        try {
            if (instance == null) {
                ...
                if (R.cacheManager() != null && R.cacheManager().getApplicationCache() != null) {
                    ...
                    EntityTemplateClass entityTemplateClass = new EntityTemplateClass(instance.getDefaultTemplateName(), BlocksConfig.getDefaultLanguage(), "<div " + ParserConstants.BLUEPRINT + "=\"" + ParserConstants.DEFAULT_ENTITY_TEMPLATE_CLASS + "\" "+ ParserConstants.CAN_EDIT_PROPERTY +"=\"\"></div>", ParserConstants.DEFAULT_PAGE_TEMPLATE, null, null);
