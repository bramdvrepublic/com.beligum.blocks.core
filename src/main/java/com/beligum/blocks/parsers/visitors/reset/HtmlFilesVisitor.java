        ...
        try {
            if(node instanceof Element) {
                ...
                if(ElementParser.isTypeOf((Element) node)) {
                    node.attr(ParserConstants.TYPE_OF, ElementParser.getTypeOf((Element) node));
                ...
                if (ElementParser.isUseBlueprint((Element)node)) {
                    node.attr(ParserConstants.USE_BLUEPRINT, ElementParser.getBlueprintName((Element) node));
                }
