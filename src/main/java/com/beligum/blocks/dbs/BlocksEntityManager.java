...
import com.beligum.base.server.ProtectedLazyEntityManager;
 ...
 */
public class BlocksEntityManager extends ProtectedLazyEntityManager implements FullTextEntityManager
{
    ...
    @Override
    public <T> void purge(Class<T> aClass, Serializable serializable)
    {
    ...
    @Override
    public MassIndexer createIndexer(Class<?>... classes)
    {
        return null;
    }
    @Override
