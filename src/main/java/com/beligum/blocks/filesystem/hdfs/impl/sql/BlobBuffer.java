 ...
 * - support for our logging system
...
public class BlobBuffer {
    ...
    public void createBlobFile() {
        ...
        try {
            ...
            raFile = null;
            isMemOnly = true;
            Logger.error("SecurityException creating BLOB file:", e);
        } catch (IOException ioe) {
            blobFile = null;
            raFile = null;
            isMemOnly = true;
            Logger.error("IOException creating BLOB file:", ioe);
        }
    }
    ...
    public byte[] getBytes(long pos, int len) throws SQLException {
        pos--;
        if (pos < 0) {
            throw new SQLException("The start position must be >= 1.", "HY090");
        }
        if (pos > length) {
            throw new SQLException("The start position is beyond the end of the data.", "HY090");
        }
        if (len < 0) {
            throw new SQLException("The length must be >= 0.", "HY090");
        }
        if (pos + len > length) {
        ...
        try {
            ...
            throw new SQLException("I/O Error: "+ e.getMessage(), "HY000");
        }
    }
    ...
    public int setBytes(long pos, byte[] bytes, int offset, int len, boolean copy)
        ...
        if (offset < 0 || offset > bytes.length) {
            throw new SQLException("The offset must be >= 0 and less than the array length.", "HY090");
        }
    ...
    public void truncate(long len) throws SQLException {
        ...
        if (len > length) {
            throw new SQLException("The value of length exceeds that of the available data.", "HY090");
        }
