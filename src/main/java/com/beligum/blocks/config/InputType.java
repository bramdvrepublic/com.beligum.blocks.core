...
public enum InputType
{
    ...
    //Used to display lists of resources in a drop-down
    ResourceList(core.Entries.INPUT_TYPE_RESOURCELIST),
    //Used to display autogenerated values. See fact block
    //this only supports strings and integers
    Immutable(core.Entries.INPUT_TYPE_IMMUTABLE)
    ;
