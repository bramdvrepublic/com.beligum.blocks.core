...
import com.beligum.blocks.core.parsers.redis.visitors.*;
...
//    @Deprecated
    ...
    private static void addFrontendScripts(Document DOM, List<Node> presentLinks, List<Node> presentScripts) throws IOException, ParseException
    {
        ...
        Document frontend = visitor.getSource(Blocks.config().getFrontEndScripts());
        ...
        Document frontendToBeAdded = new Document(Blocks.config().getSiteDomain());
