...
import com.beligum.blocks.core.parsers.visitors.template.HtmlVisitor;
...
public class EntitiesEndpoint
{
    ...
    {
        com.beligum.blocks.core.models.Blueprint blueprint = Blocks.templateCache().getBlueprint(entityClassName, Blocks.config().getDefaultLanguage());
        ...
        //
        //        if (lang.isEmpty()) lang = Blocks.config().getDefaultLanguage();
    ...
    public Response updateEntity(@PathParam("entityUrlPath") String pageUrlPath, @QueryParam("deleted") @DefaultValue("false") boolean fetchDeleted, String pageHtml)
    {
        try{
            ...
            if (pageContent != null) {
                ...
                Blocks.database().save(htmlVisitor.getContent());
            }
