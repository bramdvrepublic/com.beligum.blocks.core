...
CKEDITOR.plugins.setLang("a11yhelp", "zh", {
    ...
    legend: [{
        ...
        name: "命令", items: [{
            name: "復原命令",
            legend: "請按下「${undo}」"
        }, {name: "重複命令", legend: "請按下「 ${redo}」"}, {name: "粗體命令", legend: "請按下「${bold}」"}, {name: "斜體", legend: "請按下「${italic}」"}, {name: "底線命令", legend: "請按下「${underline}」"}, {
            name: "連結",
            legend: "請按下「${link}」"
