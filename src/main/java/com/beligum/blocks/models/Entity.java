...
//    }
//
//    public ResourceNode getRdfModel(Model model, String id) {
...
//
//        retVal.setId(Blocks.rdfFactory().ensureAbsoluteRdfValue(id));
//
...
//                        retVal.add(Blocks.rdfFactory().ensureAbsoluteRdfValue(property), e.getRdfModel(model, null));
//                    }
//                }
...
//                                retVal.add(property, new StringNode(propertyValue));
//                            }
//                            else {
//                                retVal.add(property, new StringNode(propertyValue, lang));
//                            }
//                        }
//                    }
//                }
