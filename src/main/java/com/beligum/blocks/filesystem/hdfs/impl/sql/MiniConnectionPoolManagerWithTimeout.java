 ...
 */
public class MiniConnectionPoolManagerWithTimeout implements ConnectionPoolManager
{
    ...
    private class ConnectionMonitor extends TimerTask {
        private MiniConnectionPoolManagerWithTimeout owner;

        private ConnectionMonitor(MiniConnectionPoolManagerWithTimeout owner) {
            this.owner = owner;
        }
     ...
     */
    public MiniConnectionPoolManagerWithTimeout(ConnectionPoolDataSource dataSource,
                                                int maxConnections) {
