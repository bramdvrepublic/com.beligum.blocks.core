package com.beligum.blocks.models.resources.hibernate;

import com.beligum.blocks.models.resources.interfaces.Resource;
import com.beligum.blocks.models.resources.jackson.ResourceJsonLDDeserializer;
...
public class ResourceUserType implements UserType, ParameterizedType
{
    ...
    public void nullSafeSet(PreparedStatement st, Object value, int index, SessionImplementor session) throws HibernateException, SQLException {
        ...
        String sqlJson = null;
        try {
            sqlJson = getMapper().writeValueAsString(value);
        } catch (Exception e) {
            throw new HibernateException(e);
        }
        PGobject pgo = new PGobject();
        pgo.setType(JSONB_TYPE);
        pgo.setValue(sqlJson);
        st.setObject(index, pgo);

        st.setObject(index, sqlJson, Types.OTHER);
    }
