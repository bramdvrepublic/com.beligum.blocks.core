...
//                links.add("<link href=\"" + Blocks.config().BOOSTRAP_CSS_FILEPATH + "\" rel=\"stylesheet\" />");
//                scripts.add("<script src=\"" + Blocks.config().BOOTSTRAP_JS_FILEPATH + "\"></script>");
...
//                PageTemplate pageTemplate = new PageTemplate(instance.getDefaultTemplateName(), Blocks.config().getDefaultLanguage(), "<!DOCTYPE html>\n" +
//                                                                                                                                   "<html>\n" +
//                                                                                                                                   "<head>\n" +
