...
//    {
//        Locale language = Blocks.config().getDefaultLanguage();
...
//    public Response getBlueprintPage(@PathParam("blueprintName") String blueprintName, @QueryParam("lang") String lang) throws Exception
//    {
//        Locale language = Blocks.config().getDefaultLanguage()
